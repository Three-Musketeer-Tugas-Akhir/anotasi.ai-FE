            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                ...
                <div className="p-6 lg:p-8 grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                        ...
                        <div key={s.label} className="bg-white rounded-xl p-5 border border-slate-200 shadow-sm flex flex-col items-center text-center group hover:shadow-md transition-all relative overflow-hidden">
