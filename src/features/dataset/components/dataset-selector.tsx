 ...
 * Inspired by team-switcher UIs (e.g., Vercel, Linear).
 */
  ...
  return (
    <>
      <div className="relative" ref={popoverRef}>
        ...
        {isOpen && (
          <div className="absolute top-full left-0 mt-1.5 w-72 bg-white rounded-xl border border-gray-200 shadow-lg z-50 py-1 overflow-hidden">
            {/* Header */}
